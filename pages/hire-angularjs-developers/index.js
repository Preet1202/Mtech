...
const HireAngularDevelopers = (props) => {
...
export async function getStaticProps() {
  ...
  const response = await axiosInstance.get(
    "/api/hire-angular-developer?populate=HeroSection,HeroSection.image,HeroSection.button,counter_component.count,Clientele_BrandSection.brand_logo.image,LaunchProducts.image,Services.white_box.image,card_box.cb_box,Expertise.expertise_box.image,Form.leftside_award.images,Form.button,ClutchWidget,Devprocess.image,Hiredev.image,Clientsegment.ClientSegment_box,Versus.versus_box,testimonial_banner.button,EngagementModel.Engagement_Box,Casestudy.image,Techstack.image,WhyChooseMaruti.white_box.image,DataProtection.image,DataProtection.dataprotection_box.image,Awards.images,Clutch_Review.image,Clutch_Review.button,ResourceLibrary.rl_box.image,ResourceLibrary.link,OtherServices.otherservice_box,FAQ.button,FAQ.faqitems&populate=SEO.image&populate=SEO.metaProperties&populate=SEO.keywords"
  );
  return {
    props: {
