...
const HireMobileAppDevelopers = (props) => {
  ...
  return (
    <>
      ...
      <WhiteWrapper
        ...
        textColor="#383838"
        marginBottom="80px"
        height_hire_mobile_other={true}
      />

      <Timeline
        timelinedata={props?.timeline}
        // addExtraSpacing={true}
        parentPage="hire-mobile-app"
        paddingBottom="24rem"
      />
...
export async function getStaticProps() {
  ...
  return {
    props: {
      ...
      longcta: response?.data?.attributes?.Stayahead,
