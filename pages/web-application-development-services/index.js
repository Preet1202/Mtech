...
export async function getStaticProps() {
  ...
  return {
    props: {
      ...
      webApp: response?.data?.attributes?.Webapp,
      ...
      //   seriveOtherWhiteWrapper: response?.data?.attributes?.ServicesOther,
      ...
      //   collaboration: response?.data?.attributes?.Collaborationmodel,
