...
const ArtificialIntelligenceServices = (props) => {
  ...
  return (
    <>
      ...
      <WhiteWrapper
        variant="services_secondary"
        WhiteWrapperData={props?.WhiteWrapperData_AIBenefit}
        textColor="#383838"
        color="violet"
        marginBottom="80px"
      />
...
export async function getStaticProps() {
  ...
  return {
    props: {
      ...
      WhiteWrapperData_AIBenefit: response?.data?.attributes?.AIBenefit,
      ...
      casestudyother: response?.data?.attributes?.CaseStudyOther,
