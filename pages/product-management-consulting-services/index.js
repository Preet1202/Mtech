...
const ProductManagementConsultingServices = (props) => {
  ...
  return (
    <>
      ...
      <WhiteWrapper
        ...
        textColor="#383838"
        height_product_management={true}
      />
...
export default ProductManagementConsultingServices;
...
export async function getStaticProps() {
  ...
  return {
    props: {
      ...
      roadBlock: response?.data?.attributes?.Teamsweoffer,
