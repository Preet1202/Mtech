...
const ProductDevelopmentManifest = (props) => {
...
export default ProductDevelopmentManifest;
...
export async function getStaticProps() {
  ...
  const response = await axiosInstance.get(
    "/api/paid-campaigns?filters[slug][$eq]=product-development-manifest&populate=hero_section.button,hero_section.image,counter_component.count,teams_we_offer_ai_clutch.image,form.leftside_award.images,form.button,clutch_widget,development_process.image,clientele_brand_section.brand_logo.image,long_cta.image,services.white_box.image,client_segment.ClientSegment_box,case_study.image,case_study_other.image,technology_stack.image,why_choose_maruti_techlabs.white_box.image,data_protection.image,data_protection.dataprotection_box.image,awards_recognitions.images,our_people_our_strength.image,our_people_our_strength.ourpeople_box.image,clutch_review.image,clutch_review.button,other_services.otherservice_box,faq.button,faq.faqitems,client_testimonial_video.button,client_testimonial_video.video_link.image,client_testimonial_video.variant"
  );
